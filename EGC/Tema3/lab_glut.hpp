...
namespace lab{ namespace glut{
		...
		void _keyboardDownCallback(unsigned char key_pressed, int mouse_x, int mouse_y){
			...
			if(_listener){
				...
				_listener->notifyKeyPressed(key_pressed,mouse_x,mouse_y);
			}
		}
		...
		void _keyboardUpCallback(unsigned char key_released, int mouse_x, int mouse_y){
			...
			if(_listener){ 
				...
				_listener->notifyKeyReleased(key_released,mouse_x,mouse_y);
			}
		}
		...
		void _specialDownCallback(int key_pressed, int mouse_x, int mouse_y){
			...
			if(_listener){ 
				...
				_listener->notifySpecialKeyPressed(key_pressed,mouse_x,mouse_y);
			}
		}
		...
		void _specialUpCallback(int key_released, int mouse_x, int mouse_y){
			...
			if(_listener){ 
				...
				_listener->notifySpecialKeyReleased(key_released,mouse_x,mouse_y);
			}
		}
