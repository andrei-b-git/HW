...
namespace lab{ namespace glut{
	...
	static bool* keyStates = new bool[256];					//vector care contine starile tastelor
	static bool* keySpecialStates = new bool[256];			//vector care contine starile tastelor speciale
